// "DATABASE" UTAMA KITA - VERSI FINAL
const datasets = [
    {
        id: "pneumonia-v1",
...
function displayDatasets(items) {
    ...
    items.forEach((item, index) => {
        ...
        card.innerHTML = `
            ...
            <a href="${item.link}" class="btn-card">${item.tags.includes('Premium') ? 'Dapatkan Akses' : 'Lihat Detail'}</a>`;
...
if (container) { // Hanya jalankan jika kita di halaman datasets.html
