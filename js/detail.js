document.addEventListener('DOMContentLoaded', function() {
    ...
    if (dataset) {
        ...
        if (dataset.images && dataset.image_path) {
            ...
            galleryHTML = `<section class="image-preview"><h2>Preview Gambar</h2><div class="preview-grid">${imagesHTML}</div></section>`;
        }
        contentContainer.innerHTML = `
            ...
            ${galleryHTML}
            <footer><div class="footer-content"><p>© 2025 Paijo Willbig. Dibuat dengan semangat.</p><div class="footer-links"><a href="https://github.com/paijolemu/dataset-medic.willbig" target="_blank" title="Kode Sumber di GitHub"><i class="fab fa-github"></i></a></div></div></footer>`;
        ...
        contentContainer.innerHTML = `<header class="content-header"><h1>Error 404: Dataset Tidak Ditemukan</h1><p>Maaf, dataset yang Anda cari tidak ada.</p><a href="datasets.html" class="btn">Kembali ke Daftar Dataset</a></header>`;
    }
});
